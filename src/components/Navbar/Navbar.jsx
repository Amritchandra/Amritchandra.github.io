...
function Navbar() {
    ...
    const downloadHandle = () => {
        ...
        link.click();
        window.open(
            "https://drive.google.com/file/d/1c9DoRtNiSPjUVmBKpzvHMvawOU6Y6rc8/view?usp=sharing",
            "_blank"
        );
    };
        ...
        <>
            <div id='nav-menu'>
                ...
                <div id="largeScreenNavbar">
                    <a href='#home'><h2>{"AmritChandra </>"}</h2></a>
                    ...
                    <div>
                        ...
                        <a href="https://github.com/AmritChandra" target="_blank" className="nav-link github">
                            GitHub
                        </a>
                    </div>
                </div>
